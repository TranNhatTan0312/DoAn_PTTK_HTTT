...
begin
    THEM_DOC_GIA('DG01','Nguyễn Quốc Khánh','12/02/2010','Học sinh','23 Thủ Đức','khanh23@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG02','Hoàng Thị Hòa','02/01/2009','Học sinh','13 Linh Trung ','hoa123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG03','Nguyễn Văn Linh','30/04/2008','Học sinh','23 Linh Xuân','linh123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG04','Nguyễn Thị Cẩm Vân','02/01/2010','Học sinh','TPHCM','van123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG05','Nguyễn Ngọc Thùy Dung','03/01/2008','Học sinh','TPHCM','thuydung123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG06','Nguyễn THị Minh Hương','13/02/2009','Học sinh','TPHCM','huong123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG07','Võ Đoàn Tố Loan','14/04/2010','Học sinh','TPHCM','loan123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG08','Triệu Thị Quỳnh Hương','12/04/2007','Học sinh','huong','ngan123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG09','Lê Văn Toàn','05/05/2008','Học sinh','TPHCM','toan123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG10','Lữ Thị THúy Quỳnh','01/01/2009','Học sinh','TPHCM','quynh123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG11','Trần Vĩ Khang','02/02/2008','Học sinh','TPHCM','khang123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG12','Mai Văn Nhật','03/02/2008','Học sinh','TPHCM','nhat123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG13','Nguyễn THị Vân','05/05/1991','Giáo Viên','TPHCM','van123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG14','Trần Ngọc Thiên Kym','04/05/2009','Học sinh','TPHCM','kim123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG15','Lê Phi Long','05/05/2009','Học sinh','TPHCM','long123@gmail.com','01/03/2022');
     THEM_DOC_GIA('DG16','Nguyễn Đình Đức Thịnh','05/05/2009','Học sinh','TPHCM','thinh123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG17','Trần Triệu Thiên','05/02/2009','Học sinh','TPHCM','thien123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG18','Lưu Thảo Linh','15/09/2009','Học sinh','TPHCM','linh@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG19','Dương Thị Lệ Giang','05/01/2009','Học sinh','TPHCM','giang123@gmail.com','01/03/2022');
     THEM_DOC_GIA('DG20','Lê Thị Thanh Nguyên','31/05/2009','Học sinh','TPHCM','nguyen123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG21','Lê THành Hoàn','05/12/2009','Học sinh','TPHCM','hoan123@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG22','Nguyễn Duy Khánh','21/02/2009','Học sinh','TPHCM','khanh@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG23','Đặng Bảo Trâm','20/02/2009','Học sinh','TPHCM','Tram@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG24','Nguyễn Thị THùy Dung','02/09/2009','Học sinh','TPHCM','dung@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG25','Võ Thị Ngọc Trâm','15/10/2009','Học sinh','TPHCM','Tram@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG26','Dương Minh Quang','24/05/2009','Học sinh','TPHCM','Quang@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG27','Nguyễn Thành Luân','15/10/2009','Học sinh','TPHCM','Luan@gmail.com','01/03/2022');
    THEM_DOC_GIA('DG28','Nguyễn Lê Khánh Vy','05/10/2009','Học sinh','TPHCM','Vy@gmail.com','01/03/2022');
end;
...
begin
    them_phieumuonsach('PM01','DG01','02/03/2022');
    them_phieumuonsach('PM02','DG02','04/03/2022');
    them_phieumuonsach('PM03','DG03','02/03/2022');
    them_phieumuonsach('PM04','DG04','03/03/2022');
    them_phieumuonsach('PM05','DG05','03/03/2022');
    them_phieumuonsach('PM06', 'DG06',to_date('07/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM07', 'DG07',to_date('08/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM08', 'DG08',to_date('05/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM09', 'DG09',to_date('05/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM10', 'DG10',to_date('05/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM11', 'DG11',to_date('05/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM12', 'DG12',to_date('08/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM13', 'DG13',to_date('08/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM14', 'DG14',to_date('08/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM15', 'DG15',to_date('03/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM16', 'DG16',to_date('09/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM17', 'DG17',to_date('09/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM18', 'DG18',to_date('11/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM19', 'DG19',to_date('12/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM20', 'DG20',to_date('15/03/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM21', 'DG21',to_date('01/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM22', 'DG22',to_date('14/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM23', 'DG23',to_date('15/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM24', 'DG24',to_date('15/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM25', 'DG25',to_date('15/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM26', 'DG26',to_date('23/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM27', 'DG27',to_date('23/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM28', 'DG28',to_date('26/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM29', 'DG01',to_date('26/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM30', 'DG03',to_date('28/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM31', 'DG05',to_date('28/04/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM32', 'DG07',to_date('04/05/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM33', 'DG09',to_date('04/05/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM34', 'DG11',to_date('05/05/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM35', 'DG13',to_date('05/05/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM36', 'DG15',to_date('05/05/2022','dd/mm/yyyy'));
    them_phieumuonsach('PM37', 'DG17',to_date('06/05/2022','dd/mm/yyyy'));
     them_phieumuonsach('PM38', 'DG22',to_date('06/06/2022','dd/mm/yyyy'));
END;
...
INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT02','DG02',to_date('01/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT03','DG03',to_date('01/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT04','DG04',to_date('01/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT05','DG05',to_date('02/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT06','DG07',to_date('02/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT07','DG09',to_date('02/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT08','DG11',to_date('04/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT09','DG13',to_date('04/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT10','DG15',to_date('04/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT11','DG17',to_date('04/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT12','DG14',to_date('10/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT13','DG12',to_date('10/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT14','DG06',to_date('15/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT15','DG08',to_date('20/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT16','DG10',to_date('25/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT17','DG22',to_date('25/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT18','DG24',to_date('25/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT19','DG26',to_date('25/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT20','DG28',to_date('25/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT21','DG19',to_date('26/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT22','DG07',to_date('27/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT23','DG08',to_date('27/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT24','DG09',to_date('27/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT25','DG10',to_date('27/06/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT26','DG11',to_date('01/07/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT27','DG12',to_date('01/07/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT28','DG13',to_date('01/07/2022', 'DD/MM/YYYY'),0);

INSERT INTO PHIEUTRASACH (MAPHIEUTRA, MADOCGIA, NGAYTRA, TIENPHATKINAY) VALUES ('PT29','DG14',to_date('01/07/2022', 'DD/MM/YYYY'),0);
...
-----------------------Thêm người dùng-----------------
-- 1. quản lý || 2. Thủ thư
insert into nguoidung values('CamVan', '123456',1);
insert into nguoidung values('CamVan', '123456',2);
insert into nguoidung values('ToLoan', '123456',2);
insert into nguoidung values('ThanhTu', '123456',2);
insert into nguoidung values('ThaoLinh', '123456',2);
